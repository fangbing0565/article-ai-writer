...
A boilerplate for creating new projects with Next.js, TypeScript, Antd, ESLint, Prettier, Jest, and React Testing Library. Bootstrapped with [create-next-app](https://nextjs.org/docs/api-reference/create-next-app).
<br>
<br>
